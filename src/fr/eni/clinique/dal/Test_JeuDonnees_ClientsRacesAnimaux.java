...
//		Race chartreux = new Race("Chartreux", "Chat");
//		daoRace.insert(chartreux);
//		
//	// Affichage de toutes les races de Chat
//		Race[] racesDeChat = {siamois, ragdoll, maineCoon, persan, siberien, europeen, chatGouttiere, chartreux};
//		
...
//		}
	...
	// pour désarchiver un animal
//		Race race = RaceManager.getInstance().getRace("Ragdoll", "Chat");
//		Client client = ClientManager.getInstance().getClient(7);
//		
//		Animal gandalf = new Animal(68,"Gandalf","M","blanc et gris",race,client,"tatoo-ty","", true);
//		gandalf.setArchive(false);
//		daoAnimal.update(gandalf);
